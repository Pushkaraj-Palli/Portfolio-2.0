...
const Hero = () => {
  return (
    <section className="relative bg-white/60 backdrop-blur-[2px] border-b-[5px] border-inverse-surface min-h-[819px] flex flex-col justify-center items-center px-6 text-center overflow-hidden">
      ...
      <div className="bg-grid-texture animate-grid-flow"></div>
      <div className="bg-grid-dots animate-grid-flow" style={{ animationDelay: '-5s', animationDirection: 'reverse' }}></div>

      <div className="absolute top-10 left-10 md:left-20 bg-secondary-container px-4 py-2 border-[3px] border-inverse-surface neo-shadow font-headline font-bold -rotate-6">
        HI, I'M PUSHKARAJ
      </div>
      <div className="absolute bottom-20 right-10 md:right-20 bg-tertiary-container px-4 py-2 border-[3px] border-inverse-surface neo-shadow font-headline font-bold rotate-3">
        BASED IN NYC
      </div>
