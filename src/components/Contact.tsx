        ...
        <div>
          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-center gap-4">
              ...
              <span className="font-headline font-bold text-xl">pushkarajpalli@gmail.com</span>
            </div>
            <div className="flex items-center gap-4">
              <div className="bg-inverse-surface text-white p-3 border-[2px] border-inverse-surface">
                <span className="material-symbols-outlined">location_on</span>
              </div>
              <span className="font-headline font-bold text-xl uppercase">Remote / Earth</span>
            </div>
          </div>
          <div className="mt-12 flex gap-4">
            {/* GitHub */}
            <a
              className="bg-white border-[3px] border-inverse-surface p-4 neo-shadow hover:bg-tertiary-container transition-colors"
              href="https://github.com/Pushkaraj-Palli/"
              target="_blank"
